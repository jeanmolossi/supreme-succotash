...
-   `@local/ui`: a [shadcn/ui](https://ui.shadcn.com/docs) based React component library shared by both `web` and `docs` applications
-   `@local/ts-config`: `tsconfig.json`s used throughout the monorepo
